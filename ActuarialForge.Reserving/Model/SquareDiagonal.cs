...
{
    /// <summary>
    /// Represents a diagonal of monetary values within a square matrix structure.
    /// </summary>
    /// <remarks>
    /// A <see cref="SquareDiagonal"/> is a single-currency ordered sequence of values
    /// taken from a square structure. All contained monetary amounts must use the same
    /// <see cref="Currency"/>.
    /// </remarks>
    public sealed record SquareDiagonal : IEnumerable<Money>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SquareDiagonal"/> class.
        /// </summary>
        ...
        /// </exception>
        public SquareDiagonal(IEnumerable<Money> diagonal)
        {
        ...
        /// <summary>
        /// Returns a new diagonal in which each value is scaled by the specified factor.
        /// </summary>
        /// <param name="factor">The scaling factor.</param>
        /// <returns>A new <see cref="SquareDiagonal"/> containing the scaled values.</returns>
        public SquareDiagonal Scale(decimal factor)
            => new(_diagonal.Select(d => factor * d));

        /// <summary>
        /// Determines whether this instance is equal to another <see cref="SquareDiagonal"/>.
        /// </summary>
        ...
        /// otherwise, <c>false</c>.
        /// </returns>
        public bool Equals(SquareDiagonal? other)
        {
